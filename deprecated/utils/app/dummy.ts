import { ArticleData, CardData } from "@/deprecated/types/data";

const markdownSample = JSON.parse(
...
export const articleDataDummy: ArticleData = {
  ...
  updatedAt: "2022-09-01T10:00:00.000Z",
};

export const snippetDataDummy: ArticleData = {
  _id: "2",
  title: "AI quiz: Can you tell which person is real?",
  type: "snippet",
  wordCount: 1000,
